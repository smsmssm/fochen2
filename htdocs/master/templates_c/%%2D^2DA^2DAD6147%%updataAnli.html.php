<?php /* Smarty version 2.6.18, created on 2017-05-29 18:14:00
         compiled from updataAnli.html */ ?>
...
<form name="form1" enctype="multipart/form-data">
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">编辑案例</h3></td>
				</tr>
			</table>		
...
">
           ...
           <tr>
            ...
            <td colspan="8"  class="tbbody" style="position:relative">  
            <input  type="hidden" name="aid" c  value="<?php echo $this->_tpl_vars['arr_Info_list'][0]; ?>
" />  
...
{    
  ...
  function myfunc()
 {
  ...
  if($("summary").value=="")
   ...
   form1.method = "post";
   form1.action = "edit_anli.php?tm="+new Date();
