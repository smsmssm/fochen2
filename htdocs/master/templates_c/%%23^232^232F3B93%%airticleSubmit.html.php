<?php /* Smarty version 2.6.18, created on 2017-05-29 18:27:44
         compiled from airticleSubmit.html */ ?>
...
<td colspan="8"  class="tbbody" style="position:relative">
            ...
            <td colspan="8"  class="tbbody" style="position:relative"> <input id="isSelf" type="radio" checked="true" value="是"  name="isSelf" onClick=" " />是
         <input id="SCH" type="radio" name="isSelf"   value="否" onClick=" " />否</td>            
		   </tr>
		   <tr style="display:none">
            <td width="14%" align="right"  class="tbbody">内容来源：&nbsp;</td>
            <td colspan="8"  class="tbbody" style="position:relative">   <input  id="author" name="author" type="text" value="<?php echo $this->_tpl_vars['arr_Info_list'][2]; ?>
