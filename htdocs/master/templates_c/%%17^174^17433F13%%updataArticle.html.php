<?php /* Smarty version 2.6.18, created on 2017-05-29 18:31:02
         compiled from updataArticle.html */ ?>
...
<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">编辑文章</h3></td>
				</tr>
			</table>	
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
...
<td colspan="8"  class="tbbody" style="position:relative">
         ...
         <input id="SCH" type="radio" name="isSelf" checked="true"   value="否" onClick=" " />否</td>            
		   ...
		   <tr style="display:none">
            <td width="14%" align="right"  class="tbbody">内容来源：&nbsp; <input  type="hidden" name="aid" c  value="<?php echo $this->_tpl_vars['arr_Info_list'][0]; ?>
" /></td>
            <td colspan="8"  class="tbbody" style="position:relative">   <input  id="author" name="author" type="text" value="<?php echo $this->_tpl_vars['arr_Info_list'][6]; ?>
" class="smallInput" size="30" maxlength="255">
