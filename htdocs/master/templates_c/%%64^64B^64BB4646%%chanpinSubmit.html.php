<?php /* Smarty version 2.6.18, created on 2017-05-29 18:31:30
         compiled from chanpinSubmit.html */ ?>
...
<form name="form1" enctype="multipart/form-data">
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">新增产品应用</h3></td>
				</tr>
			</table>		
...
">
           ...
           <tr>
            ...
            <input type="file" name="File" id="File"  style="margin:10px 10px;">（支持 jpg,png,gif格式）
...
<tr>
            <td width="14%" align="right"  class="tbbody">产品详情：&nbsp;</td>
...
{    
  ...
  function myfunc()
 {
  ...
  if($("summary").value=="")
   ...
   form1.method = "post";
   form1.action = "accept_chanpin.php?tm="+new Date();
