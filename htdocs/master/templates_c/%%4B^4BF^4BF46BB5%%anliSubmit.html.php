<?php /* Smarty version 2.6.18, created on 2017-05-29 16:24:48
         compiled from anliSubmit.html */ ?>
...
<form name="form1" enctype="multipart/form-data">
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">新增案例</h3></td>
				</tr>
			</table>		
		   ...
		   <tr>
            <td width="14%" align="right"  class="tbbody">案例类别：&nbsp;</td>
...
<tr>
            <td width="14%" align="right"  class="tbbody">案例内容：&nbsp;</td>
...
{    
  ...
  function myfunc()
 {
  ...
  if($("summary").value=="")
   ...
   form1.method = "post";
   form1.action = "accept_anli.php?tm="+new Date();
