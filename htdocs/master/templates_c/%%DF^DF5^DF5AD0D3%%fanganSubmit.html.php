<?php /* Smarty version 2.6.18, created on 2017-05-29 18:41:58
         compiled from fanganSubmit.html */ ?>
...
<form name="form1" enctype="multipart/form-data">
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">新增方案</h3></td>
				</tr>
			</table>		
		   ...
		   <tr>
            <td width="14%" align="right"  class="tbbody">方案类别：&nbsp;</td>
...
">
           ...
           <tr>
            ...
            <td colspan="8"  class="tbbody" style="position:relative">   <input  id="kw" name="kw" type="text" value="" class="smallInput" size="30"  width="400" maxlength="255">（多个可用逗号隔开如：智能监控，远程监控，远程控制）            </td>            
		   </tr>
           <tr>
            <td width="14%" height="79" align="right"  class="tbbody">封面图片：&nbsp;</td>
            <td colspan="8"  class="tbbody" style="position:relative"> 
            

            <!--img id="img" src="" style="width:95px; height:75px;"-->
            <input type="file" name="File" id="File" style="margin:10px 10px;">（可以不传，上传有利于推广,支持jpg png gif格式）
...
<tr>
            <td width="14%" align="right"  class="tbbody">方案内容：&nbsp;</td>
...
<iframe id="form_target" name="form_target" style=" width:100px; height:100px;">
</iframe>
<script language="javascript">
  ///var content="";
...
{    
  ...
  function myfunc()
 {
  ...
  if($("summary").value=="")
   ...
   form1.method = "post";
   form1.action = "accept_fangan.php?tm="+new Date();
