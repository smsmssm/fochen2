<?php /* Smarty version 2.6.18, created on 2017-05-29 18:12:48
         compiled from updataFangan.html */ ?>
...
<form name="form1" enctype="multipart/form-data">
			<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td height="10"><h3 style="width:98%; margin-left:2%; margin-top:20px; color:#3F7CAB">编辑方案</h3></td>
				</tr>
			</table>		
...
{    
  ...
  function myfunc()
 {
  ...
  if($("summary").value=="")
   ...
   form1.method = "post";
   form1.action = "edit_fangan.php?tm="+new Date();
