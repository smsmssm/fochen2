...
if(api_verify_session()){
	if(api_verify_point($usr)==-100){
		...
		$sql="select id,FcreateTime,Fname,Femail,Fstatus,FisCloud,FisBigData,FisFangan,FisGongye,FisNongye,FisJiaju,FisYiliao,FisChengshi,FisChe from tcompany where Femail='45169132@qq.com'  order by id DESC";
