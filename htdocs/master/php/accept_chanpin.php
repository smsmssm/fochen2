...
if(api_verify_session()){
	///if(api_verify_point($usr)==-100){
     ...
     $forder="../../pictemp/chanpin/";
	 $icon_url = "../../uploadfile/img/chanpin/";
	  $picname = time();
...
$content = mysql_escape_string(str_replace("\\","",$content));
 ...
 $sql="INSERT INTO  tchanpin(Ftitle,Fstyle,FcreateTime,Fkeywords,Fcid,Fcontent,Fsummary,Flogo) VALUES  ('".$an."',"."'".$s."',"."'".$date."',"."'".$kw."',"."'".$cid."',"."'".$content."',"."'".$summary."',"."'".$picname."')";
 
 mysql_query($sql);
 ///echo $sql;///return;
  
  
  $sql="select FcreateTime from tchanpin where FcreateTime='".$date."'";
  ...
  $row = mysql_fetch_array($result, MYSQL_NUM);
   ...
   if($row[0]==$date){
		   ...
		   echo api_redirectWithAlert("保存成功","show_new_chanpin.php"); 
       }
	   else{
	       echo api_redirectWithAlert("系统忙","show_new_chanpin.php");
      }
