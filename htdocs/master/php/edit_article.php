...
// $sql="INSERT INTO  tnews(Ftitle,Fstyle,FcreateTime,Fauthor,Fkeywords,Fcid,Fis_self,Fcontent,Fsummary) VALUES  ('".$an."',"."'".$s."',"."'".$date."',"."'".$at."',"."'".$kw."',"."'".$cid."',"."'".$is."',"."'".$content."',"."'".$summary."')";
 	...
 	$sql = "update tnews set Ftitle="."'".$an."'".",Fstyle="."'".$s."'".",Fauthor="."'".$at."'".",Fkeywords="."'".$kw."'".",Fcid="."'".$cid."'".",Fis_self="."'".$is."'".",Fcontent="."'".$content."'".",Fsummary="."'".$summary."'".",Fstatus=0"." where id='".$aid."'";//" where Fname='".$usr."'";
 ...
 // $row = mysql_fetch_array($result, MYSQL_NUM);
  // mysql_close($link);
   //if($row[0]==$date){
         //  echo "保存成功,审核完后将发布";
		 //  return;
		  echo api_redirectWithAlert("文章保存成功","show_new_airticle.php"); 
      // }
	  // else{
	       // echo "保存失败";
			//return;
