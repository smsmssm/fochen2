...
if(api_verify_session()){
	...
	mysql_select_db($dbName, $link);
		...
		$sql="select Ftitle,Fstatus,FcreateTime,id,FvisitTimes from tnews ".$addtion." order by id DESC   limit ".(($page-1)*20).","."20";
		///echo $sql;
		$result = mysql_query($sql,$link); 
		$sql = "select count(*) from tnews ".$addtion;
...
$smarty->display("showNewArticleList.html"); 
mysql_close($link);
?>