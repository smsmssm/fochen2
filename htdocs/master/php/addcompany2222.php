...
if(api_verify_session()){
	if(api_verify_point($usr)<=2){
		$sql="select id,Fmail,FcompanyName,Fsname,FwebSite,Fintroduce,Fprovince,Fcity,Faddr,FzipCode,Ftel,Ffax,Farea,FcontactPerson,Frange,Fqq,FstaffNumber,Fsetup,Fcustomer,Fproduct,Ftype from erpdq.tcompany where Fmail='".$usr."'";
