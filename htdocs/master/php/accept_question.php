...
mysql_select_db($dbName, $link);
 $sql="INSERT INTO  tquestions(Ftitle,Fstyle,FcreateTime,Fauthor,Fkeywords,Fcid,Fis_self,Fcontent,Fsummary) VALUES  ('".$an."',"."'".$s."',"."'".$date."',"."'".$at."',"."'".$kw."',"."'".$cid."',"."'".$is."',"."'".$content."',"."'".$summary."')";
 
 mysql_query($sql);
 echo $sql;///return;
  
  $sql="select FcreateTime from tnews where FcreateTime='".$date."'";
